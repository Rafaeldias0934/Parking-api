...
public class JwtUtils {
    ...
    private static final long EXPIRE_MINUTE = 2;
    ...
    public static Date toExpireDate(Date start) {
        ...
        LocalDateTime end = dateTime.plusDays(JwtUtils.EXPIRE_DAYS).plusHours(JwtUtils.EXPIRE_HOURS).plusMinutes(JwtUtils.EXPIRE_MINUTE);
