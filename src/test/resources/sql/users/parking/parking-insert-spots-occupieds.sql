 -- Insere usuários
    ...
    insert into parking_spots(id, code, status) values (3, 'A-03', 'OCCUPIED');
    insert into parking_spots(id, code, status) values (4, 'A-04', 'OCCUPIED');
    ...
    values ('20250311-095300', 'FIT-8021', 'FIAT', 'YAMAHA', 'RED', '2025-03-11 09:57:00', 1, 2);
     ...
     insert into clients_spots(receipt_number, plate, brand, model, color, entry_date, id_client, id_parking_spots)
        values ('20230316-101600', 'SIE-1040', 'FIAT', 'SIENA', 'VERDE', '2023-03-14 10:15:00', 2, 3);

     insert into clients_spots(receipt_number, plate, brand, model, color, entry_date, id_client, id_parking_spots)
        values ('20250528-143000', 'FIT-8021', 'FIAT', 'YAMAHA', 'RED', '2025-03-11 09:57:00', 1, 4);